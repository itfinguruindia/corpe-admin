      ...
      <div className="max-w-[1440px] mx-auto flex flex-col gap-4">
        ...
        {tracker.installmentInfo?.firstInstallmentDue && (
          <div className="bg-amber-50 border border-amber-300 rounded-xl p-4 flex items-center gap-3 shadow-sm">
            ...
            <div>
              <p className="text-sm font-bold text-amber-900">1st Installment Payment Required</p>
              <p className="text-xs text-amber-700 mt-0.5">
                The Digital Signature Certificate (DSC) section in Stage 2 and all of Stages 3 &amp; 4 are locked
                until the client pays the 1st Installment.
                <a href={`/clients/${appNo}/pricing-and-payment`} className="underline font-semibold ml-1">
        ...
        {tracker.installmentInfo?.secondInstallmentDue && (
          <div className="bg-amber-50 border border-amber-300 rounded-xl p-4 flex items-center gap-3 shadow-sm">
            <AlertCircle className="w-5 h-5 text-amber-600 shrink-0" />
            <div>
              <p className="text-sm font-bold text-amber-900">2nd Installment Payment Required</p>
              <p className="text-xs text-amber-700 mt-0.5">
                Stages 3 &amp; 4 are locked until the client pays the 2nd Installment.
                <a href={`/clients/${appNo}/pricing-and-payment`} className="underline font-semibold ml-1">
                  Go to Pricing &amp; Payment
                </a>
              </p>
                        ...
                        <div key={section._id} className="bg-white">
                          ...
                          <div className="px-4 py-2 bg-slate-50 flex items-center justify-between border-b border-slate-100">
                            <div className="flex items-center gap-2 min-w-0">
                              ...
                              {(section.label === "Digital Signature Certificate (DSC)" ||
                                section.label === "Digital Signature Certificate (DSC) procedure" ||
