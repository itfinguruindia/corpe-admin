...
import { Search, Bell, Plus, RefreshCcw, ArrowLeft, Undo2 } from "lucide-react";
...
export default function ClientsHeader() {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-37 w-full items-center justify-between bg-white px-8 shadow-sm border-b border-[#F36541]">
    ...
    + Create New Company
      ...
      <div className="flex items-center gap-6">
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full text-[#F36541] hover:bg-gray-100 transition-colors"
        >
